...
const EditCuotaModal = ({ isOpen, cuota, onClose, onSuccess }) => {
  ...
  // Cargar datos de la cuota cuando abre el modal
  useEffect(() => {
    if (isOpen && cuota) {
      setFormData({
        mes: cuota.mes,
  ...
  const handleSubmit = async (e) => {
    ...
    // Validar
    if (!formData.mes || !formData.ano || !formData.monto || !formData.fechaVencimiento) {
    ...
    try {
      ...
      await axios.put(`${API_ENDPOINTS.CUOTAS.GET_ALL}/${cuota.id}`, {
