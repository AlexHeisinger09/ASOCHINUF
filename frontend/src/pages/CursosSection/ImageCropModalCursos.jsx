...
const ImageCropModalCursos = ({ isOpen, onClose, imageSrc, onCropComplete, isDarkMode }) => {
          ...
          >
            ...
            <div className={`p-6 space-y-4 ${
              ...
              <div className={`text-xs p-3 rounded-lg ${
                isDarkMode ? 'bg-[#8c5cff]/10 text-gray-400' : 'bg-purple-50 text-gray-600'
              }`}>
                La imagen será optimizada a 800x600 píxeles para verse perfectamente en las tarjetas
              </div>
...
const getCroppedImg = async (imageSrc, pixelCrop, rotation = 0) => {
  ...
  // Redimensionar a 800x600 para optimizar (4:3 ratio)
  const finalCanvas = document.createElement('canvas');
  const finalCtx = finalCanvas.getContext('2d');
  finalCanvas.width = 800;
  finalCanvas.height = 600;

  finalCtx.drawImage(canvas, 0, 0, pixelCrop.width, pixelCrop.height, 0, 0, 800, 600);
...
export default ImageCropModalCursos;
