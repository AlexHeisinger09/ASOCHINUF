...
const CursosSection = ({ containerVariants }) => {
  ...
  return (
    <motion.div
      ...
      exit="exit"
    >
      <h2 className={`text-3xl font-bold mb-6 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Mis Cursos</h2>
      <div
        className={`${
      ...
      >
        ...
        <p className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>Los cursos se mostrarán aquí</p>
      </div>
    </motion.div>
  );
};
